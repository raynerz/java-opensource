package ch.bfh.loscompaneros.arena.controller;

import ch.bfh.loscompaneros.arena.model.Party;
import ch.bfh.loscompaneros.arena.service.BattleService;
...
public class ArenaController {
    ...
    public String battle(@RequestBody List<Party> challengers) {
        ...
        String winner = battleService.battle(challenger, challenger);
